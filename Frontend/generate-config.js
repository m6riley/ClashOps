...
const envKeys = {
  ...
  'YOUR_CREATE_SUBSCRIPTION_FUNCTION_KEY': process.env.CREATE_SUBSCRIPTION_KEY,
  'YOUR_CANCEL_SUBSCRIPTION_FUNCTION_KEY': process.env.CANCEL_SUBSCRIPTION_KEY,
  'YOUR_GET_SUBSCRIPTION_STATUS_FUNCTION_KEY': process.env.GET_SUBSCRIPTION_STATUS_KEY,
  'YOUR_RENEW_SUBSCRIPTION_FUNCTION_KEY': process.env.RENEW_SUBSCRIPTION_KEY,
  'YOUR_STRIPE_WEBHOOK_FUNCTION_KEY': process.env.STRIPE_WEBHOOK_KEY,
  'YOUR_SEND_VERIFICATION_CODE_FUNCTION_KEY': process.env.SEND_VERIFICATION_CODE_KEY,
};
