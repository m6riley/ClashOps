...
function VersatilityIcon({ className, size = 20 }) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      <defs>
        <linearGradient id="versatilityGradient" x1="0" y1="0" x2="0" y2="1">
      ...
      <g>
        <g>
          <path
            fill="none"
            stroke="url(#versatilityGradient)"
            strokeWidth="4"
            strokeMiterlimit="10"
        ...
        <g>
          <path
            ...
            strokeWidth="4"
            strokeMiterlimit="10"
            d="M63,38c0,1.65-1.35,3-3,3H40c-1.65,0-3-1.35-3-3
